...
# pytesseract.pytesseract.tesseract_cmd = r'c:Users\gompa\Downloads\pytesseract'

# Set the Tesseract executable path
east_model_path = r'C:\Users\gompa\Desktop\text_extractor\backend\frozen_east_text_detection.pb'
...
# # Function to extract bounding boxes from EAST text detection model output
# def box_extractor(scores, geometry, min_confidence):
#     num_rows, num_cols = scores.shape[2:4]
#     rectangles = []
#     confidences = []
...
#     ap = argparse.ArgumentParser()
#     ap.add_argument('-v', '--video', type=str, help='path to optional video file')
#     ap.add_argument('-east', '--east', type=str, required=True, help='path to EAST text detection model')
#     ap.add_argument('-c', '--min_confidence', type=float, default=0.5, help='minimum confidence to process a region')
...
#     ap.add_argument('-p', '--padding', type=float, default=0.0, help='padding on each ROI border')
#     arguments = vars(ap.parse_args())
#     return arguments
